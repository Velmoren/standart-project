...
WashersId.getInitialProps = async ({ query }) => {
	const ID = query.id;
	return { ID };
};

function WashersId(props) {
	let { ID } = props;
	...
	const idType = "912fc794-394a-11e9-9fa8-00155d0e072e";
	const path_link = [
		{ label: "Главная", path: "/" },
		{ label: "Каталог", path: "/catalog" },
		{ label: "Шайбы", path: "/catalog/washers" },
	];

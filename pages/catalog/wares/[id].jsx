...
WaresId.getInitialProps = async ({ query }) => {
	const ID = query.id;
	return { ID };
};

function WaresId(props) {
	let { ID } = props;
	...
	const idType = "dbe38c4a-394a-11e9-9fa8-00155d0e072e";
	const path_link = [
		{ label: "Главная", path: "/" },
		{ label: "Каталог", path: "/catalog" },
		{ label: "Изделия с внутренним шестигранником", path: "/catalog/wares" },
	];

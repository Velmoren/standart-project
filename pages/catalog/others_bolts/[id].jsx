...
OtherBoltsId.getInitialProps = async ({ query }) => {
	const ID = query.id;
	return { ID };
};

function OtherBoltsId(props) {
	let { ID } = props;
	...
	const idType = "06d29a2a-394b-11e9-9fa8-00155d0e072e";
	const path_link = [
		{ label: "Главная", path: "/" },
		{ label: "Каталог", path: "/catalog" },
		{ label: "Прочие болты", path: "/catalog/others_bolts" },
	];
